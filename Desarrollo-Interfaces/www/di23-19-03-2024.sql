...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2024 a las 11:52:01
...
(1, 'Usuarios', 0, NULL, 4),
(2, 'CRUD', 1, 'getVistaMenuSeleccionado(\'Usuarios\', \'getVistaUsuarios\');', 4),
(3, 'Disabled', 0, NULL, 5),
(4, 'Mtto', 0, NULL, 6),
(5, 'Mtto.Menús', 4, 'getVistaMenuSeleccionado(\'Menu\', \'getVistaMttoMenus\');', 4),
(6, 'Mtto.Permisos', 4, 'getVistaMenuSeleccionado(\'Permisos\', \'getVistaPermisos\');', 5);
...
--
ALTER TABLE `permiso`
  ADD CONSTRAINT `permiso_ibfk_1` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `usuario_permiso`
  ADD CONSTRAINT `usuario_permiso_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuario_permiso_ibfk_2` FOREIGN KEY (`id_permiso`) REFERENCES `permiso` (`id_permiso`) ON DELETE CASCADE ON UPDATE CASCADE;
