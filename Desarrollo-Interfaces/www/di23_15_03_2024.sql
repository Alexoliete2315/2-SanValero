...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-03-2024 a las 13:31:15
...
(1, 'Usuarios', 0, NULL, 2),
(2, 'CRUD', 1, 'getVistaMenuSeleccionado(\'Usuarios\', \'getVistaUsuarios\');', 2),
(3, 'Disabled', 0, NULL, 2),
(4, 'Mtto', 0, NULL, 2),
(5, 'Mtto.Menús', 4, 'getVistaMenuSeleccionado(\'Menu\', \'getVistaMttoMenus\');', 2);
